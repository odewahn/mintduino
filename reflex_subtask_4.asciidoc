...
////
At this point, things are getting a bit confusing. A circuit diagram would be helpful. I suggest Fritzing, which you can get for free at http://fritzing.org. It allows you draw schematics that look a lot like the real thing. It does have a component for Arduino, which I feel would be acceptable to use here even though this is not technically an Arduino.
...
////
It would be good to use red wire--both here and elsewhere in the book--to connect anything to +5V.
////
