Sub-Task 4 will require the following components beyond what you've already assembled. You will also need to 

* 1 Resistor (100 ohm minimum), included in the Survival Pack
* 5 Jumper Wires (by now, you have probably used up the jumper wire in the Survival Pack)
