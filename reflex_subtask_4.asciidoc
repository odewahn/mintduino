...
* 5 Jumper Wires (by now, you have probably used up the jumper wire in the Survival Pack, so you'll need to dip into the jumper wire kit recommended in xref:the_reflex_game[])
