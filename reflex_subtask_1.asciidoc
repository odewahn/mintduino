...
////
Regarding the above, I think it would be better to explicitly instruct the reader which side the long lead should go on, to avoid future confusion, and to allow them to visually  compare their circuit to yours.
////
